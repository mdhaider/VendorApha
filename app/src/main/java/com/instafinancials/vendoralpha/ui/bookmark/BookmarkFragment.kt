...
class BookmarkFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        bookmarkModel =
            ViewModelProviders.of(this).get(BookmarkModel::class.java)

        searchHistoryList = ArrayList()

        searchHistoryList.add(0, BookmarkData("DHRRIFN9404000595", 1576298763437))
        searchHistoryList.add(0, BookmarkData("8UDJFHHDHDHDHHDB3", 1570290860437))
        searchHistoryList.add(0, BookmarkData("908IFN9404000595", 1570298763437))
        searchHistoryList.add(0, BookmarkData("78DJFHHDHDHDHHDB3", 1520290860437))

        binding.rvBookmarkList.setHasFixedSize(true)
        adapter = BookmarkAdapter(searchHistoryList)
